...
function setBatteryInfo(info) {
        ...
        $.ajax({
                type: "GET",
                url: "actionHandler/ajaxSet_Battery.php",
                data: { batteryInfo: jsonInfo },
                success: function(data) {
                        jAlert("Success");
                },
                error: function() {
		...
		<div id="div5" class="form-row">
			...
			<span class="value">Press "Restore Factory Settings" to activate your Gateway <span style="padding-left:231px">Default Settings. All your previous settings will be lost.</span></span>
                ...
                <div id="div7" class="form-row odd">
                        <span class="readonlyLabel"><a href="#" class="btn" id="btn7" title="Reset Battery Connection" style="text-transform : none;">RESET BATTERY CONNECTION</a></span>
                        <span class="value">Press "Reset Battery Connection" to restore wireless connectivity <span style="padding-left:231px">with your backup battery</span></span>
                </div>
	</div> <!-- end .module -->
	</form>
</div><!-- end #content -->
