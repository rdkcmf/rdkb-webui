	...
	$("[name='channel_bandwidth1']").change(function() {
		...
		if (!$("#channel_bandwidth201").prop("checked")) {
			...
			//160MHz
				...
				$("#channel_number").val('36');
				$("#channel_number").find("[value='116'],[value='132'],[value='136'],[value='140'],[value='144'],[value='149'],[value='153'],[value='157'],[value='161'],[value='165']").prop("disabled", true).prop("selected", false);			
			}
		}
		else {
