...
function showDialog() {
	...
	//disable wep if 11n
	if ("n"==$("#wireless_mode").val() || "n,ac"==$("#wireless_mode").val() || "a,n,ac"==$("#wireless_mode").val() || "g,n"==$("#wireless_mode").val()) {
...
<div id="content">
	...
	<div id="educational-tip">
		...
		<p class="hidden"><strong>Mode:</strong>  <?php echo $radio_band; ?> GHz operates in 802.11 g/n mode.</p>
