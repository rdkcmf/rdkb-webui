...
<body class="si-twilight-background">
	<div id="dp-nav">
		<img src="cmn/syndication/img/<?% echo $partner_logo_file; ?>" style="margin: 15px;" />
	</div>
	<div class="dp-content">
		...
		<div class="dp-space-filler-30"></div>
		<p class="dp-text dp-gray-text">To resume access to the Internet on your home network, open the <?% echo $partner_brandname; ?> <?% echo $partner_productname; ?> app or visit <?% echo $partner_url; ?> using a different connection or device.</p>
	</div>
</body>
