...
function populateIPv6Addr(v6addr){
	...
	{
		return !IsBlank('ip6_address_r') || (IsBlank('ip6_address_r') && IsBlank('dmz_host_address_'));
	}

	function isIp4AddrRequired()
	{
		return !IsBlank('dmz_host_address_') || (IsBlank('ip6_address_r') && IsBlank('dmz_host_address_'));
	}
...
$('#save_setting').click(function() {
	...
	if (isEnabledDMZ) {
		...
		if(isValid && !IsBlank("ip6_address_r")) {
