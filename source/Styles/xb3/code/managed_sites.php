      ...
      <legend class="acs-hide"><?php echo _("Trusted devices management")?></legend>
		...
		for ($i=0; $i < $hostNums; $i++) {
			...
			foreach( $TrustedUser as $key => $value ){
				...
				if ($value['HostDescription'] == $Host["$i"]['HostName']){
        	...
        	<div id=\"block-time-" .$ID. "\" class=\"block-time\">
              ...
              <label for=\"time_end_ampm-" .$ID. "\" class='acs-hide'></label>
        		...
        		<div class=\"form-row weekday\">
        			<input  name=\"day\" class=\"blockedDay-" .$ID. "\"  type=\"checkbox\" id=\"monday-" .$ID. "\"  value=\"Mon\"" . ( ((stristr($block_days, "Mon") != false)|| ($blockedInfo['AlwaysBlock']=="true")) ? " checked='checked'" : "" ). "/><label class=\"checkbox\" for=\"monday-" .$ID. "\">"._("Monday")."</label><br />
        			<input  name=\"day\" class=\"blockedDay-" .$ID. "\"  type=\"checkbox\" id=\"tuesday-" .$ID. "\"  value=\"Tue\"" . ( ((stristr($block_days, "Tue") != false)|| ($blockedInfo['AlwaysBlock']=="true")) ? " checked='checked'" : "" ). " /><label class=\"checkbox\" for=\"tuesday-" .$ID. "\">"._("Tuesday")."</label><br />
        			<input  name=\"day\" class=\"blockedDay-" .$ID. "\"  type=\"checkbox\" id=\"wednesday-" .$ID. "\"  value=\"Wed\"" . (((stristr($block_days, "Wed") != false)|| ($blockedInfo['AlwaysBlock']=="true")) ? " checked='checked'" : "" ). " /><label class=\"checkbox\" for=\"wednesday-" .$ID. "\">"._("Wednesday")."</label><br />
        			<input  name=\"day\" class=\"blockedDay-" .$ID. "\"  type=\"checkbox\" id=\"thursday-" .$ID. "\"  value=\"Thu\"" . ( ((stristr($block_days, "Thu") != false)|| ($blockedInfo['AlwaysBlock']=="true")) ? " checked='checked'" : "" ). " /><label class=\"checkbox\" for=\"thursday-" .$ID. "\">"._("Thursday")."</label><br />
        			<input  name=\"day\" class=\"blockedDay-" .$ID. "\"  type=\"checkbox\" id=\"friday-" .$ID. "\"  value=\"Fri\"" . ( ((stristr($block_days, "Fri") != false)|| ($blockedInfo['AlwaysBlock']=="true")) ? " checked='checked'" : "" ). " /><label class=\"checkbox\" for=\"friday-" .$ID. "\">"._("Friday")."</label><br />
        			<input  name=\"day\" class=\"blockedDay-" .$ID. "\"  type=\"checkbox\" id=\"saturday-" .$ID. "\"  value=\"Sat\"" . (((stristr($block_days, "Sat") != false)|| ($blockedInfo['AlwaysBlock']=="true")) ? " checked='checked'" : "" ). " /><label class=\"checkbox\" for=\"saturday-" .$ID. "\">"._("Saturday")."</label><br />
        			<input  name=\"day\" class=\"blockedDay-" .$ID. "\"  type=\"checkbox\" id=\"sunday-" .$ID. "\"  value=\"Sun\"" . ( ((stristr($block_days, "Sun") != false)|| ($blockedInfo['AlwaysBlock']=="true")) ? " checked='checked'" : "" ). " /><label class=\"checkbox\" for=\"sunday-" .$ID. "\">"._("Sunday")."</label>
        		</div>
        	</div> <!-- end #block-time -->
