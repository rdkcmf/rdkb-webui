...
<div id="content">
	<h1><?php echo _('Advanced > HS Port Forwarding > Add Service')?></h1>
	...
	<div class="module forms">
		<h2><?php echo _('Add HS Port	Forward')?></h2>
		<div class="form-row odd">
			<label for="service_name"><?php echo _('Service Name:')?></label> <input type="text" class="text" value="" id="service_name" name="service_name" />
		</div>
		<div class="form-row">
		...
		<div class="form-row">
			<label for="start_public_port"> <?php echo _('Start Public Port:')?></label>  <input type="text" class="text" value="80" id="start_public_port" name="start_public_port" size="10"/>
		</div>
		<div class="form-row odd">
			<label for="end_public_port"><?php echo _('End Public Port:')?></label>  <input type="text" class="text" value="80" id="end_public_port" name="end_public_port" disabled size="10"/>
		</div>
	    <div class="form-row ">
			<label for="private_port"><?php echo _('Private Port(s):')?></label>  <input type="text" class="text" value="8080" id="private_port" name="private_port" size="10" />
		</div>
		<div class="form-row odd">
			<label for="enable_port_range"><?php echo _('Enable Port Range:')?> </label><input type="checkbox" id="enable_port_range" name="enable_port_range" value="<?php echo _('Enable Private Port Range')?>" disabled="disabled" /><b>  <?php echo _('Enable Private Port Range')?> </b>
		</div>
		<div class="form-btn">
			<input type="button" id="btn-save" value="<?php echo _('Add')?>" class="btn submit"/>
