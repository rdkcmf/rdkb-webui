...
session_start();
	...
	if("Disabled"==$_SESSION["psmMode"]){
		...
		foreach ($ssids as $i){
			...
			if ("Up" == getStr("Device.WiFi.Radio.$r.Status") && "Up" == getStr("Device.WiFi.SSID.$i.Status")){	//bwg has radio.enable, active status is “at least one SSID and its Radio is enabled”
				$sta_wifi = "true";
				break;
			}
		}	
		...
		if ( $bridge_mode == "router" && ("true" == $wifi_24_enabled || "true" == $wifi_50_enabled) && ("true" == $wifi_24_radio || "true" == $wifi_50_radio)) {
			echo '<div class="module forms" id="wifi-config">';
				...
				if ((($wifi_24_ssid == $wifi_50_ssid) && ($wifi_24_passkey == $wifi_50_passkey)) || !("true" == $wifi_24_enabled && "true" == $wifi_50_enabled) || !("true" == $wifi_24_radio && "true" == $wifi_50_radio)  ) {
					...
					echo '<div class="form-row even">';
						echo '<div class="form-row even">';
							echo '<span class="readonlyLabel" style="white-space: pre;"'; echo $width_pass; echo '>'._("Wi-Fi SSID (2.4 GHz):").'</span>';
							echo '<span class="value" style="white-space: pre;">';echo $wifi_24_ssid;echo '</span>';
						echo '</div>';
						if ("admin" == $_SESSION["loginuser"] && "None" != $wifi_24_secmode) {
							echo '<div class="form-row even">';
								echo '<span class="readonlyLabel" style="white-space: pre;"'; echo $width_pass; echo '>'._("Wi-Fi Passkey (2.4 GHz):").'</span>';
					...
					echo '<div class="form-row odd">';
						echo '<div class="form-row odd">';
							echo '<span class="readonlyLabel" style="white-space: pre;"'; echo $width_pass; echo '>'._("Wi-Fi SSID (5 GHz):").'</span>';
							echo '<span class="value" style="white-space: pre;">';echo $wifi_50_ssid;echo '</span>';
						echo '</div>';
						if ("admin" == $_SESSION["loginuser"] && "None" != $wifi_50_secmode) { 
							echo '<div class="form-row odd">';
								echo '<span class="readonlyLabel" style="white-space: pre;"'; echo $width_pass; echo '>'._("Wi-Fi Passkey (5 GHz):").'</span>';
