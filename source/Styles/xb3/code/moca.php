...
<div id="content" >
    ...
    <div class="module forms enable">
		...
		<div class="form-row odd" id="div_channel_switch">
			...
			<input tabindex='0' id="scan_auto"   type="radio" value="auto"   name="channel_switch" checked="checked" onclick="return scanAuto()">
			<label for="scan_auto" class="acs-hide"></label>
			<b>Scan</b>
			<input id="scan_manual" type="radio" value="manual" name="channel_switch" <?php if (("false"==$scan_method) && $isNotAdmin) echo 'checked="checked"'; ?> onclick="return scanManual()"/>
