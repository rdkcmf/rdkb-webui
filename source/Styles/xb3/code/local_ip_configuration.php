...
<!--     			<span id="ipv4_dhcp_beginning_address" class="readonlyValue"></span> -->
                <?php  
				 ...
				 $dhcp_min = getStr("Device.DHCPv4.Server.Pool.1.MinAddress");
                                 $beginArr = explode(".", $dhcp_min); 
                           }
                           else
                           {
    		...
    		<div class="form-row odd">
                ...
                <?php  
    			   $endAddr = $dhcpv4_value["endAddr"];
                           if (!strcmp($SecWebUI, "true")) {
				$dhcp_max = getStr("Device.DHCPv4.Server.Pool.1.MaxAddress");
                                $endArr = explode(".", $dhcp_max);
                           }
                           else
                           {
