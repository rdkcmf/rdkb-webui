...
$radioband1                     = (strstr($feq_band,"2.4G")) ? _("2.4") : _("2.4");
$radioband2                     = (strstr($feq_band1,"5G")) ? "5" : "5";
$feq_band                     = (strstr($feq_band,"2.4G")) ? _("2.4 GHz") : _("2.4 GHz");
...
/* 	$("#filtering_mode").change(function() {
	...
	*/
	...
	if($Mesh_Mode == 'true'  && "mso"=="<?php echo $_SESSION["loginuser"]; ?>"){
                //disable WiFi mode when Mesh is enabled for MSO
                $('#wireless_mode1, #wireless_mode').prop("disabled", true);
...
<div class="module data data div_private_wifi">
	...
	<tr class="form-row odd">
		<td headers="private-Name"><b><font color="black" style="white-space: pre-wrap;overflow-wrap: break-word;"><?php echo $network_name; ?></font></b></td>
	...
	<tr class="form-row">
		<td headers="private-Name"><b><font color="black" style="white-space: pre-wrap;overflow-wrap: break-word;"><?php echo $network_name1; ?></font></b></td>
