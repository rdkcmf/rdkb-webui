...
<?php
	...
	$not_bridge_static_pages = array('local_ip', 'firewall', 'managed', 'parental', 'forwarding', 'triggering', 'dmz', 'routing', 'nat', 'dynamic_dns', 'device_discovery', 'radius_servers', 'dlna', 'digital_media', 'samba', 'local_users', 'moca', 'wps', 'wifi_spectrum_analyzer');
