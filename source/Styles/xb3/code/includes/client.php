...
class Client
{
    ...
    */
    ...
    private function executeRequest($url, $parameters = array(), $http_method = self::HTTP_METHOD_GET, array $http_headers = null, $form_content_type = self::HTTP_FORM_CONTENT_TYPE_MULTIPART)
    {
        ...
        // force curl out of erouter0 as this is the external interface
        // some devices don't have default routes and require this
        curl_setopt( $ch, CURLOPT_INTERFACE, "erouter0" );
        $result = curl_exec($ch);
